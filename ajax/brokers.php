...
switch ($_POST['opt'])
{
	case 1:	 
		...
		{
			if ($newMember = $model->addBroker($_POST))
...
// 	E-mails
	...
	case 4:
		if ($_POST['memberId'])
		{
			if ($model->addHistoryBroker($_POST))
				echo 1;
			else 
				echo 0;
		}
	...
	case 5:
		if ($_POST['memberId'])
		{
			if ($historyArray = $model->getHistoryBrokerEntries($_POST['memberId']))
			{
